...
type Rule interface {
	IsSatisfied(index int, record *helpers.TradingRecord) bool
}
...
func (ar andRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
...
func (or orRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
...
func (oir OverIndicatorRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
...
func (uir UnderIndicatorRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
...
func (pgr percentChangeRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
