...
type Strategy interface {
	ShouldEnter(index int, record *helpers.TradingRecord) bool
	ShouldExit(index int, record *helpers.TradingRecord) bool
}
...
func (rs RuleStrategy) ShouldEnter(index int, record *helpers.TradingRecord) bool {
	if rs.EntryRule == nil {
...
func (rs RuleStrategy) ShouldExit(index int, record *helpers.TradingRecord) bool {
	if rs.ExitRule == nil {
