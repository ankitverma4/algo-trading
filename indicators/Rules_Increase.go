...
// index.
func (ir IncreaseRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
	if index == 0 {
		return false
	}
...
// index.
func (dr DecreaseRule) IsSatisfied(index int, record *helpers.TradingRecord) bool {
	if index == 0 {
		return false
	}
